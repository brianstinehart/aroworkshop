...
- `rating-web` on GitHub: <https://github.com/adriangigante/rating-web.git>
...
<a class="github-button" href="https://github.com/adriangigante/rating-web.git" data-icon="octicon-repo-forked" data-size="large" aria-label="Fork microsoft/rating-web on GitHub">Fork</a>
